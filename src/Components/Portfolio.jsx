...
const projectList = [
  ...
  {
    title: "GitHub Codespaces and introduction",
    description:
      "The first parts of the Student Developer Pack course in GitHub, this video introduces you to Codespaces and how to use them.",
